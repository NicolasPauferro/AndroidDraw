...
class App extends React.Component<AppProps, AppState> {
  ...
  private handleCanvasPointerDown = (
    ...
    // S-Pen eraser toggle logic:
    // On Samsung devices, the barrel button often reports as button 2 or buttons bitmask 2.
    if (
      ...
      // Prevent context menu or other default behaviors
      event.preventDefault();
      // Ensure we don't start drawing while holding the button
      return;
    }
  ...
  private handleCanvasPointerUp = (
    ...
    // S-Pen eraser revert logic:
    // Revert to the previous tool when the S-Pen barrel button is released.
    if (
      event.pointerType === "pen" &&
      this.state.activeTool.type === "eraser" &&
      this.state.activeTool.lastActiveTool
